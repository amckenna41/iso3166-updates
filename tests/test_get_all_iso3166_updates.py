...
@unittest.skip("Skipping tests to pull all updates from data sources to not overload servers.")
class ISO3166_Updates_Tests(unittest.TestCase):
    ...
    test_get_updates_df:
        testing get_updates_df() function that converts the 2 dimensional converted html table array 
...
#6.)
        with self.assertRaises(TypeError):
            test_updates_df_error1 = iso3166_updates.get_updates_df(test_alpha2_error_1)
            test_updates_df_error2 = iso3166_updates.get_updates_df(test_alpha2_error_2)
            test_updates_df_error3 = iso3166_updates.get_updates_df(test_alpha2_error_3)
