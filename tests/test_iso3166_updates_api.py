...
#2.)
        ...
        for alpha2 in sorted(list(iso3166.countries_by_alpha2.keys())):
            ...
            self.assertEqual(test_request.status_code, 200, 
                "Expected 200 status code from request for alpha2 code {}, got {}.".format(alpha2, test_request.status_code))
            self.assertEqual(test_request.headers["content-type"], "application/json", 
                "Expected Content type to be json for alpha2 code {}, got {}.".format(alpha2, test_request.headers["content-type"]))
...
#1.)
        ...
        self.assertIsInstance(test_request.json(), dict, "Expected output object of API to be type dict, got {}.".format(type(test_request)))
...
#2.)
        ...
        self.assertIsInstance(test_request_ad, dict, "Expected output object of API to be type dict, got {}.".format(type(test_request_ad)))
        self.assertIsInstance(test_request_ad[test_alpha2_ad], list, "Expected ouput object of API should be type list, got {}.".format(type(test_request_ad[test_alpha2_ad])))
...
#3.)
        ...
        self.assertIsInstance(test_request_bo, dict, "Expected output object of API to be type dict, got {}".format(type(test_request_bo)))
        self.assertIsInstance(test_request_bo[test_alpha2_bo], list, "Expected ouput object of API should be type list, got {}.".format(type(test_request_bo[test_alpha2_bo])))
...
#4.)
        ...
        self.assertIsInstance(test_request_co, dict, "Expected output object of API to be type dict, got {}.".format(type(test_request_co)))
        self.assertIsInstance(test_request_co[test_alpha2_co], list, "Expected ouput object of API should be type list, got {}.".format(type(test_request_co[test_alpha2_co])))
...
#5.)
        ...
        self.assertIsInstance(test_request_bo_co_dm, dict, "Expected output object of API to be type dict, got {}.".format(type(test_request_bo_co_dm)))
        self.assertEqual(list(test_request_bo_co_dm.keys()), test_alpha2_list, "Expected columns do not match output.")
        for alpha2 in test_alpha2_list:
                self.assertIsInstance(test_request_bo_co_dm[alpha2], list, "Expected ouput object of API should be type list, got {}.".format(type(test_request_bo_co_dm[alpha2])))
        ...
        self.assertEqual(test_request_bo_co_dm['BO'][0], test_alpha2_bo_expected, "Expected observed and expected outputs to match.")
        self.assertEqual(test_request_bo_co_dm['CO'][0], test_alpha2_co_expected, "Expected observed and expected outputs to match.")
        self.assertEqual(test_request_bo_co_dm['DM'][0], test_alpha2_dm_expected, "Expected observed and expected outputs to match.")
#6.)
...
#1.)
        ...
        for alpha2 in list(test_request):
                for row in test_request[alpha2]:
                        self.assertEqual(list(row.keys()), expected_output_columns, "Expected columns do not match output, got \n{}.".format(list(row.keys())))
                        self.assertIsInstance(row, dict, "Expected output row object of API to be of type dict, got {}.".format(type(row)))
...
#1.)
        ...
        for alpha2 in list(test_request):
                for row in test_request[alpha2]:
                        self.assertEqual(list(row.keys()), expected_output_columns, "Expected columns do not match output, got \n{}.".format(list(row.keys())))
                        self.assertIsInstance(row, dict, "Expected output row of object of API to be of type dict, got {}.".format(type(row)))
        self.assertIsInstance(test_request[test_ad_2015[0]], list, "Expected output object of API to be of type list, got {}.".format(type(test_request[test_ad_2015[0]])))
        self.assertEqual(test_ad_2015_expected, test_request[test_ad_2015[0]][0], "Expected observed and expected outputs of API to match.")
...
#2.)   
        ...
        for alpha2 in list(test_request):
                for row in test_request[alpha2]:
                        self.assertEqual(list(row.keys()), expected_output_columns, "Expected columns do not match output, got \n{}.".format(list(row.keys())))
                        self.assertIsInstance(row, dict, "Expected output row of object of API to be of type dict, got {}.".format(type(row)))
        self.assertIsInstance(test_request[test_es_2002[0]], list, "Expected output object of API to be of type list, got {}".format(type(test_request[test_es_2002[0]])))
        self.assertEqual(test_es_2002_expected, test_request[test_es_2002[0]][0], "Expected observed and expected outputs of API to match.")
...
#3.) 
        ...
        for alpha2 in list(test_request):
                for row in test_request[alpha2]:
                        self.assertEqual(list(row.keys()), expected_output_columns, "Expected columns do not match output, got \n{}.".format(list(row.keys())))
                        self.assertIsInstance(row, dict, "Expected output row of object of API to be of type dict, got {}.".format(type(row)))
        self.assertIsInstance(test_request[test_hr_2011[0]], list, "Expected output object of API to be of type list, got {}.".format(type(test_request[test_hr_2011[0]])))
        self.assertEqual(test_hr_2011_expected, test_request[test_hr_2011[0]][0], "Expected observed and expected outputs of API to match.")
...
#4.)
        ...
        for alpha2 in list(test_request):
                for row in test_request[alpha2]:
                        self.assertEqual(list(row.keys()), expected_output_columns, "Expected columns do not match output, got \n{}.".format(list(row.keys())))
                        self.assertIsInstance(row, dict, "Expected output row of object of API to be of type dict, got {}.".format(type(row)))
        self.assertIsInstance(test_request[test_ma_2019[0]], list, "Expected output object of API to be of type list, got {}".format(type(test_request[test_ma_2019[0]])))
        self.assertEqual(test_ma_2019_expected, test_request[test_ma_2019[0]][0], "Expected observed and expected outputs of API to match.")
...
#6.)
        ...
        self.assertEqual(test_request, {}, "Expected output of API to be an empty dict, got \n{}".format(test_request))
#7.) 
    ...
    def test_month(self):
        ...
        test_month_6 = "abc"
#1.)
        test_request = requests.get(self.base_url + '?months=' + test_month_1, headers=self.user_agent_header).json()
